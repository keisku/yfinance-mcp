...
TOOLS = [
    ...
    Tool(
        ...
        description=(
            ...
            "SMA (Simple Moving Average), EMA (Exponential Moving Average), WMA (Weighted Moving Average): trend-following indicators, price above = uptrend. "
            "RSI (Relative Strength Index): momentum oscillator, >70 overbought, <30 oversold. "
            "MACD (Moving Average Convergence Divergence): trend/momentum indicator, histogram>0 bullish. "
            "BB (Bollinger Bands): volatility bands showing price ranges. "
            "Stochastic Oscillator (Slow): momentum indicator, %K/%D >80 overbought, <20 oversold. "
            "Fast Stochastic Oscillator: more responsive version, %K/%D >80 overbought, <20 oversold. "
            "CCI (Commodity Channel Index): >100 overbought, <-100 oversold. "
            "DMI (Directional Movement Index): +DI/-DI trend direction, ADX>25 strong trend. "
            ...
            "Ichimoku Kinko Hyo (Equilibrium Chart): comprehensive cloud indicator, price above cloud = bullish. "
            ...
            "Fibonacci Retracement: support/resistance levels at key ratios (23.6%, 38.2%, 50%, 61.8%). "
